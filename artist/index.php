                            ...
                            <tbody>
                                ...
                                if ($resfetchinngPendingBooking->rowCount() != 0) {
                                    while ($rowfetchinngPendingBooking = $resfetchinngPendingBooking->fetch()) {
                                        $bookingDate = date('Y-m-d', strtotime($rowfetchinngPendingBooking['Date']));

                                        if ($bookingDate === $todayDate) {
                                            $bookings[] = $rowfetchinngPendingBooking;
                                        }
                                    }
                                    ...
                                    foreach ($bookings as $rowfetchinngPendingBooking) {
                                ?>
                                        <tr>
                                            ...
                                            <td><?= date("g:i a", strtotime($rowfetchinngPendingBooking["Time"])) ?></td>
                                            <td class="text-center">
                                                <button class="btn btn-success btn-sm rounded"
                                                    value="<?= $rowfetchinngPendingBooking['RowNum'] ?>" id="showBookingInfo">
                                                    <i class="fa fa-eye"></i>
                                                </button>
                                            </td>
                                        </tr>
