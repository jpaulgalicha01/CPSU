...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <button class="btn btn-success mb-2"><i class="fa fa-plus" aria-hidden="true"></i> Add Description</button>
            <div class="table-responsive">
                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                    ...
                    <div class='col-12 py-2'>
                        ...
                        <div class='d-md-flex d-sm-grid justify-content-around'>
                            <div class="py-2">
                                ...
                                <input type="text" class="form-control" id="ServicesName" name="ServicesName" required>
                            </div>
                            <div class="py-2">
                            <label for="ServicePrice">Price</label>
                                <div class="input-group mb-3">
                                    ...
                                    <input type="int" class="form-control" name="ServicePrice" id="ServicePrice" required>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
const checkingModal = document.getElementById('checkingModal').value;

// if(checkingModal == "editServices"){
//     $("#ServicesName").val("asddd");
//     $("#ServicePrice").val("asdd");
//     $("#checkingModal").val("addServices");
// }
