...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <button class="btn btn-success mb-2" data-toggle="modal" data-target="#addServices"><i class="fa fa-plus"
                    aria-hidden="true"></i> Add Services</button>
                            ...
                            while ($row = $res->fetch()) {
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <button class="btn btn-success btn-sm rounded" title="Edit" id="view_services"
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <button class="btn btn-success mb-2" data-toggle="modal" data-target="#addProfileImages"><i
                            ...
                            while ($row = $res->fetch()) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <button class="btn btn-danger btn-sm rounded" title="Delete"
                                            value="<?= $row['RowNum'] ?>"><i class="fa fa-trash"
                                                style="color: #ffffff;"></i></button>
                                    </td>
                                </tr>
                                <?php
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            if ($res->rowCount() == 0) {
                ?>
                <button class="btn btn-success mb-2" data-toggle="modal" data-target="#addDescription"><i class="fa fa-plus"
                        aria-hidden="true"></i> Add Description</button>
                <?php
            }
            ?>
            <div class="table-responsive">
                        ...
                        if ($res->rowCount() != 0) {
                            while ($row = $res->fetch()) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <button class="btn btn-success btn-sm rounded" title="Edit" id="view_description"
                                            value="<?= $row['RowNum'] ?>"><i class="fa fa-edit"
                                                style="color: #ffffff;"></i></button>
                                    </td>
                                </tr>
...
<!-- Add Services -->
<div class="modal fade" id="addServices" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-content">
            ...
            <form action="inputConfig.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class='col-12 py-2'>
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control" id="ProfImg" name="Images"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" name="creating_services"
                        id="creating_services">Save</button>
                </div>
...
<!-- Profile Images -->
<div class="modal fade" id="addProfileImages" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<!-- Description Images -->
<div class="modal fade" id="addDescription" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
