                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    <a href="index.php" class="text-decoration-none d-block d-lg-none">
                        <h5 class="m-0 display-5 font-weight-semi-bold"
                            style="font-size: calc(.5vw + 1.0vh + 1.5vmin);"><span
                                class="text-primary font-weight-bold  px-3 mr-1"><img src="img/logo1.png"
                                    style="max-width:60px;" /></span>Mukha Web App</h5>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            if (isset($_COOKIE['UserID']) && $_COOKIE['TypeUser'] == "Client") {
                                ?>
                                <a href="client/" class="nav-item nav-link">Dashboard</a>
                                <?php
                            } else {
                                ?>
